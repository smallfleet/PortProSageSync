...
public partial class MainForm
{
    ...
    private TextBox _emailSmtpHost = new();
    private NumericUpDown _emailSmtpPort = new() { Minimum = 1, Maximum = 65535, Value = 587 };
    private CheckBox _emailUseSsl = new() { Text = "Use SSL" };
    private TextBox _emailFromAddress = new();
    private TextBox _emailUsername = new();
    private TextBox _emailPassword = new() { UseSystemPasswordChar = true };
    private TextBox _emailRecipients = new();
